...
class ChiDinhDichVu(QWidget):
    ...
    def on_them_dichvu(self):
        ...
        print(f"[DEBUG on_them_dichvu] self.current_phieu_kham_id = {self.current_phieu_kham_id}")
        if not self.current_phieu_kham_id:
            ...
            conn.close()
            print(f"[DEBUG on_them_dichvu] existing_pk = {existing_pk}")
            ...
            if existing_pk:
                ...
                print(f"[DEBUG on_them_dichvu] Reusing existing phieu: id={self.current_phieu_kham_id}, so_phieu={existing_pk[1]}")
            else:
                ...
                try:
                    ...
                    try:
                        ...
                        print(f"✅ Tạo tự động: Phiếu={so_phieu}, Chỉ định={so_chi_dinh}")
                    except Exception as e:
                        print(f"❌ Lỗi tạo số chỉ định: {e}")
                    
                    print(f"[DEBUG on_them_dichvu] Created new phieu: id={phieu_id}, so_phieu={so_phieu}")
                except Exception as e:
