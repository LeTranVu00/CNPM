...
class DonThuocKhac(QWidget):
    ...
    def initUI(self):
        ...
        group_info.setStyleSheet("color: #0078D7; font-weight: bold;")
        grid = QGridLayout()
        ...
        lbl_ds.setStyleSheet("color: #0078D7; font-weight: bold;")
    ...
    def load_patients(self):
        ...
        try:
            ...
            for id, name, ngaysinh, gioitinh, tuoi, dienthoai, diachi, doituong, record in patients:
                # Chỉ hiển thị tên bệnh nhân, không hiển thị số hồ sơ ở đây
                display_name = name
